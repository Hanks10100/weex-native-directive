<!-- http://dotwe.org/vue/4e47594a25abbcc84939ae726caed999 -->

<template>
  <recycle-list :list-data="dataset" template-key="type" alias="cell">
    <cell-slot template-type="floor">
      <floor
        :title="cell.title"
        :desc="cell.desc"
        :count="cell.count"
        :pictures="cell.pictures"
      ></floor>
    </cell-slot>
  </recycle-list>
</template>
